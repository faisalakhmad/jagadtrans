...
<div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo form_open('master/kec_tambah',' id="FormulirTambah" class="form-horizontal"');?>  
...
<div class="modal fade" id="editData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo form_open('master/kec_edit',' id="FormulirEdit" class="form-horizontal"');?>  
                    ...
                    <div class="panel-body">
                        <div class="modal-wrapper">
                            <div class="modal-text">
                                <h4>Yakin ingin menghapus data kecamatan <label id="nama_hapus"></label> ?</h4> 
                            </div>
                        </div>
                    </div>
                    <footer class="panel-footer"> 
                        <div class="row">
                            <div class="col-md-12 text-right"> 
                                <?php echo form_open('master/kec_delete',' id="FormulirHapus"');?>  
...
<script type="text/javascript">
            var tableinstansi = $('#instansi').DataTable({  
                "serverSide": true, 
                "order": [], 
                "ajax": {
                    "url": "<?php echo base_url()?>master/data_jenis_kec",
                    "type": "GET"
                }, 
                "columnDefs": [
                    { 
            ...
            function edit(elem){
                ...
                $.ajax({
                    type: 'GET',
                    url: '<?php echo base_url()?>master/kec_detail',
                    data: 'id=' + dataId,
                    dataType    : 'json',
