...
<div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo form_open('master/instansitambah',' id="FormulirTambah" class="form-horizontal"');?>  
...
<div class="modal fade" id="editData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo form_open('master/instansi_edit',' id="FormulirEdit" class="form-horizontal"');?>  
            ...
            <div class="modal-dialog">
                ...
                <section class="panel  panel-danger">
                    ...
                    <footer class="panel-footer"> 
                        <div class="row">
                            <div class="col-md-12 text-right"> 
                                <?php echo form_open('master/instansi_delete',' id="FormulirHapus"');?>  
...
<script type="text/javascript">
            var tableinstansi = $('#instansi').DataTable({  
                ...
                "order": [], 
                "ajax": {
                    "url": "<?php echo base_url()?>master/datainstansi",
                    "type": "GET"
                }, 
                "columnDefs": [
                    { 
            ...
            function edit(elem){
                ...
                $.ajax({
                    type: 'GET',
                    url: '<?php echo base_url()?>master/instansi_detail',
                    data: 'id=' + dataId,
                    dataType    : 'json',
