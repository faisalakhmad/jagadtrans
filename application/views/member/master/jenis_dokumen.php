...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			Master Data <?php echo ucwords($label_title); ?>
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo base_url('dashboard/index'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="javascript:void(0);"><i class="fa fa-gear"></i> Master Data</a></li>
			<li class="active">Master Data <?php echo ucwords($label_title); ?></li>
		</ol>
	</section>
...
<div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo form_open('master/jenis_dok_tambah',' id="FormulirTambah" class="form-horizontal"');?>  
            <div class="modal-header">
                <h4 class="modal-title">Tambah <?php echo ucwords($label_title); ?></h4>
            </div>
            <div class="modal-body">
                <div class="form-group nama">
                    <label class="col-sm-3 control-label">Nama <?php echo ucwords($label_title); ?> <span class="required">*</span></label>
                    <div class="col-sm-9">
...
<div class="modal fade" id="editData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo form_open('master/jenis_dok_edit',' id="FormulirEdit" class="form-horizontal"');?>  
            <input type="hidden" name="idd" id="idd">
            <div class="modal-header">
                <h4 class="modal-title">Edit <?php echo ucwords($label_title); ?></h4>
            </div>
            <div class="modal-body">
                <div class="form-group nama">
                    <label class="col-sm-3 control-label">Nama <?php echo ucwords($label_title); ?> <span class="required">*</span></label>
                    ...
                    <div class="panel-body">
                        <div class="modal-wrapper">
                            <div class="modal-text">
                                <h4>Yakin ingin menghapus data <label id="nama_hapus"></label> ?</h4> 
                            </div>
                        </div>
                    </div>
                    <footer class="panel-footer"> 
                        <div class="row">
                            <div class="col-md-12 text-right"> 
                                <?php echo form_open('master/jenis_dok_delete',' id="FormulirHapus"');?>  
...
<script type="text/javascript">
            var tableinstansi = $('#jenis_dokumen').DataTable({  
                "serverSide": true, 
                "order": [], 
                "ajax": {
                    "url": "<?php echo base_url()?>master/data_jenis_dok",
                    "type": "GET"
                }, 
                "columnDefs": [
                    { 
            ...
            function edit(elem){
                ...
                $.ajax({
                    type: 'GET',
                    url: '<?php echo base_url()?>master/jenis_dok_detail',
                    data: 'id=' + dataId,
                    dataType    : 'json',
