...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			Daftar <?php echo ucwords($label); ?>
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo base_url('dashboard/index'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
			<li class="active">Daftar <?php echo ucwords($label); ?></li>
		</ol>
	</section>
			...
			<div class="col-md-12">
				<div class="box">
					<div class="box-header with-border">
                        <?php  
                        echo level_user('user','list_driver', $this->session->userdata('kategori'),'add') > 0 ? '<a class="btn btn-success btn-sm" href="#" data-toggle="modal" data-target="#tambahData"><i class="fa fa-plus"></i> Tambah</a>':'&nbsp;';
                        ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" name="kategori" value="<?php echo ID_KATEGORI_USER_DRIVER; ?>">
        ...
        <div class="panel-body">
            <div class="modal-wrapper">
                <div class="modal-text">
                    <h4>Yakin ingin menghapus data driver <label id="nama_hapus"></label> ?</h4> 
                </div>
            </div>
        </div>
        <footer class="panel-footer"> 
